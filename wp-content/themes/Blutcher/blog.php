		...
		<div class="row">
			<div class="col-md-12">
				<div class="alognside-text">
					<h4>Alongside delivering raw dog food we like providing a dose of positive, inspiring and informative content to our passionate community of dog lovers!</h4>
				</div>
			</div>
			<?php 
   // the query
		...
		<div class="row">
			<div class="finde-box-update">
				...
				<div class="frequnly-btn">
					<a href="<?php echo get_site_url();?>/faq">Frequently asked questions</a>
				</div>
			</div>
		</div>
	</div>
