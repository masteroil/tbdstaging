<?php
/* template name: buildbox */

get_header();

?>

<section class="comob-boxx build-a-box-banner" id="all-page-header-space">
	<div class="container">
		<div class="row">
				...
				<div class="way-your-combo">
					<div class="combo-box-thre">
						<ul class="way-list-left">
							...
							<li><a href="#" class="boxse-btn-s">Build a Box</a></li>
						</ul>
					</div>
				</div>
				<div class="way-your-combo">
...
<section class="build-boxx-product-baner">
	<div class="container">
		...
		<div class="row">
						...
						<?php
	$args = array( 'post_type' => 'product', 'posts_per_page' => 20, 'product_cat' => "build-a-box", 'order'=>'DESC');
...
defrosting your dog’s meals in the fridge.</p>
                                    <a href="<?php echo get_site_url();?>/product/sealed/sealed-storage-bowl/">Add to order</a>
            </div>
        </div>
    </div>
