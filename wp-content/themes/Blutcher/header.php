...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_site_url(); ?>/wp-content/themes/Blutcher/assets/css/custom-style20.css"> -->
    <link rel="stylesheet" href="<?php echo get_site_url(); ?>/wp-content/themes/Blutcher/assets/css/style.css">
...
<body>
    ...
    <div class="header-alert alert alert-success">
        ...
        $10 Off your first Combo Box! <a href="<?php echo get_site_url(); ?>/my-account/">Register <i
            ...
            <nav class="navbar navbar-expand-md bg-light navbar-light">
                ...
                <div class="collapse navbar-collapse without-login descktop-nav-b <?php echo $menucus; ?>" id="">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" id="cus-show">
                                <div class="my-flex">
                                    ...
                                    <a class="dropdown-item" href="<?php echo get_site_url(); ?>/raw-meals">
                                        <div class="images-combo-b-dog">
                                            <img class="slide-bar-no-hover-i"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo get_site_url(); ?>/reviews/">Reviews</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="abs-right dext descktop-view-dsp">
                    ...
                    if (is_user_logged_in()) {
                        ...
                        <a href="<?php echo get_site_url(); ?>/my-account/"
                            class="allmenu-hover-ef-b only-display-acoun-open">My
