...
<?php else : ?>
	<img src="<?php echo get_site_url(); ?>/wp-content/uploads/2021/01/TBD_Payment_White_160px.png" class="woocommerce-cusimg">
	<p class="woocommerce-cusinfo">No saved methods found</p>

	<style>
	.accout-of-new .woocommerce-MyAccount-content a.button.woocomerce_btncus {display: block !important;background: #a4866c!important;color: #000!important;
border-color: #a4866c!important;padding: 0 10px 3px!important;line-height: 44px !important;}
</style>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="button woocomerce_btncus" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
<?php endif; ?>
