...
<div class="woocommerce_account_subscriptions">
    ...
    <table
        class="my_account_subscriptions my_account_orders woocommerce-orders-table woocommerce-MyAccount-subscriptions shop_table shop_table_responsive woocommerce-orders-table--subscriptions">
        ...
        <tbody>
            ...
            <tr
                class="order woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $subscription->get_status() ); ?>">
                <td class="subscription-id order-number woocommerce-orders-table__cell woocommerce-orders-table__cell-subscription-id woocommerce-orders-table__cell-order-number"
                    ...
                    <a
                        href="<?php echo esc_url( $subscription->get_view_order_url() ); ?>"><?php echo esc_html( sprintf( _x( '#%s', 'hash before order number', 'woocommerce-subscriptions' ), $subscription->get_order_number() ) ); ?></a>
    ...
    <div class="no-order-empety-design">
        <div class="under-order-empety-design">
            <img src="<?php echo get_site_url();?>/wp-content/themes/Blutcher/assets/images/TBD_Delivered_Hover.png">
            <p>You've got no subscriptions yet</p>
            <a
                href="/shop-2/?swoof=1<https%3A%2F%2Fthebutchersdog.com.au%2Fshop-2%2F%3Fswoof%3D1&product_cat=raw-meals%2Ccombo-boxes%2Ctreats%2Capothecary">Subscribe
                and save</a>
        </div>
    </div>
