...
<!-- <div class="subscription-hedline">
		<p>We have recently upgraded our website and customer database to improve your online experience.</p>

		<p>As a security measure, we require that you set a <a href="/my-account/lost-password/">new login password</a>. 
		</p>
	</div> -->

<div class="u-columns col2-set" id="customer_login">

    <div class="u-column1 col-1" id="login_head">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register"
            ...
            <p class="woocommerce-form-row form-row">
                ...
                <button type="submit"
                    ...
                    name="register"
                    value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Join the pack', 'woocommerce' ); ?></button>
            </p>
