...
<section class="map-sec">
    <div class="container">
        ...
        <div class="alwas-way-dog">
            <h2 class="find-h3">The butcher’s dog was always the fittest and healthiest dog in the neighbourhood and
                it’s no different today.</p>
        </div>
        ...
        <div class="row">
            <div class="main-become-top">
                ...
                <div class="card-b-c-se">
                    <p>If you are a Butcher Shop or Pet store owner who would like to stock our products, please get in
                        touch.</p>
                </div>
