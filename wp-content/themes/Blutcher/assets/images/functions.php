...
function so_25789472_template_include( $template ) {
  ...
  if ( is_singular('product') && (has_term( 'build-a-box', 'product_cat')) ) {
    $template = get_stylesheet_directory() . '/woocommerce/single-product-buildbox.php';
  }
    ...
    <script type="text/javascript">
            ...
            jQuery( document ).ajaxComplete(function() {
            	...
            	if (jQuery('.cfw-module table > tbody .one-off').length === 0) {
				   jQuery('<tr class="one-off"><th colspan="2">One-off totals</th></tr>').insertBefore('.cfw-module table > tbody > tr:first');
				}
