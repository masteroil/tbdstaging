...
<script>function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","UA-120646479-1")</script>
<script>!function(e,t,a,n){e[n]=e[n]||[],e[n].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});var g=t.getElementsByTagName(a)[0],m=t.createElement(a);m.async=!0,m.src="https://www.googletagmanager.com/gtm.js?id=GTM-WGBQLHN",g.parentNode.insertBefore(m,g)}(window,document,"script","dataLayer")</script>
...
<body x-data="build()" class="pt-12 md:pt-20 bg-gray-900" :class="{ &#39; overflow-y-hidden&#39;: openBuild, &#39;overflow-y-hidden &#39;: openCart,  &#39;overflow-y-hidden&#39;: showContactOverlay }" x-init="() =&gt; {
    ...
    setPrices({&quot;price&quot;:49.9});
              ...
              <div class="myy-pupy-calculetor">
                ...
                <div x-show="dogType === &#39;puppy&#39;" class="flex justify-center items-center mb-3 calculetsecound-lastinput">
                  ...
                  <div class="inline-block relative ml-2">
                    <select @change="dogAge = $event.target.options[$event.target.selectedIndex].value.toLowerCase()" name="weight" class="calculetor-input secound-in-box customtrigger">
     ...
     <div class="calculetor-footer"><p><b>GUIDE ONLY:</b> Food requirements of your dog taper as they reach maturity. Intake also depends on activity level and breed.</p></div>
    </div>
    ...
    setTimeout(function(){
      ...
      var select = document.querySelector('.calculetor-input')
 select.value = "puppy";
