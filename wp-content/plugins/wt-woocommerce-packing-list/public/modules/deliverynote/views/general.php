...
<table class="wf-form-table">
	...
	Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
		array(
			...
			'field_vl' => 'Yes',
			'help_text' => __('Enable to group the products based on a category in the delivery note.','wf-woocommerce-packing-list')
		),
		array(
			'type'=>"checkbox",
		...
		array(
			...
			'label'=>__("Show 'Print Delivery Note' button for selected order statuses",'wf-woocommerce-packing-list'),
