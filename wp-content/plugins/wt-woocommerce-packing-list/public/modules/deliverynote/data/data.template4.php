        ...
        <div class="wfte_invoice-header_top clearfix">
            <div class="wfte_col-1 float_left clearfix">
                <div class="float_left">
                    <div class="wfte_doc_title">__[Delivery note]__</div>
                </div> 
            </div>
          </div>
        <div class="wfte_invoice-header_top clearfix">
...
.wfte_doc_title{ color:#FFF; font-size:30px; font-weight:bold; height:auto; width:100%; line-height:22px;}
...
.wfte_product_table_head th{ height:36px; padding:0px 5px; font-size:.75rem; text-align:center; line-height:15px; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif;}
.wfte_product_table_body td, .wfte_payment_summary_table_body td{ text-align:center; font-size:12px; line-height:15px;}
