...
class Wf_Woocommerce_Packing_List_Shippinglabel
{
	...
	*/
	...
	public function hide_empty_elements($hide_on_empty_fields,$template_type)
	{
		if($template_type==$this->module_base)
		{
			...
			$hide_on_empty_fields[]='wfte_fragile';
			$hide_on_empty_fields[]='wfte_thiswayup';
			$hide_on_empty_fields[]='wfte_keepdry';
		}
	...
	public function get_customizable_items($settings,$base_id)
	{
		if($base_id==$this->module_id)
		{
			...
			return array(
				...
				'fragile'=>__('Fragile','wf-woocommerce-packing-list'),
				'thiswayup'=>__('This way up','wf-woocommerce-packing-list'),
				'keepdry'=>__('Keep dry','wf-woocommerce-packing-list'),
	...
	*/
	public function single_checkbox_fields($settings,$base_id){
		if($base_id == $this->module_id){
			$settings = array(
				'woocommerce_wf_enable_multiple_shipping_label' => "No",
			);
		}
		return $settings;
	}
