...
<div class="wfte_rtl_main wfte_invoice-main wfte_main wfte_custom_shipping_size"> 
    ...
    <div class="wfte_row wfte_padding_left_right clearfix" style="margin-top:10px;">
        ...
        <div class="wfte_col-3 float_left" style="">
    ...
    <div class="wfte_row wfte_padding_left_right clearfix" style="margin-top:20px;">
        <div class="wfte_col-2 float_left">
            <img src="[wfte_fragile_url]" class="wfte_fragile_img wfte_fragile">
            <img src="[wfte_thiswayup_url]" class="wfte_thiswayup_img wfte_thiswayup">
            <img src="[wfte_keepdry_url]" class="wfte_keepdry_img wfte_keepdry">
        </div>
