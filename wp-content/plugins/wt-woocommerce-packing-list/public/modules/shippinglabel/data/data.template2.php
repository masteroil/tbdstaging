...
<div class="wfte_rtl_main wfte_invoice-main wfte_main wfte_custom_shipping_size"> 
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        ...
        <div class="wfte_col-4 float_right">
            <div class="wfte_shipping_details wfte_invoice_data " data-wfte_name="invoice_data">
                ...
                <div class="wfte_total_no_of_items wfte_hidden clearfix wfte_text_left">
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        ...
        <div class="wfte_col-3 float_left">
            ...
            <div class="wfte_tel" style="font-size: 15px;">
    ...
    <div class="wfte_row wfte_return_policy wfte_padding_left_right clearfix wfte_hidden" style="margin-top:10px;">
        <div class="wfte_col-1 float_right">
            <div class="wfte_return_policy wfte_text_left clearfix wfte_hidden" data-wfte_name="return_policy" style="width:100%; height:auto; padding:5px 0px; margin-top:5px;">
            [wfte_return_policy]
            </div>
        </div>
    </div>
    ...
    <div class="wfte_row wfte_padding_left_right wfte_footer clearfix wfte_hidden" style="margin-top:10px;">
        <div class="wfte_col-1 float_right">
            <div class="wfte_footer wfte_text_left clearfix wfte_hidden" data-wfte_name="footer" style="height:auto; padding:5px 0px; margin-top:5px;">
            [wfte_footer]
            </div>
        </div>
    </div>
