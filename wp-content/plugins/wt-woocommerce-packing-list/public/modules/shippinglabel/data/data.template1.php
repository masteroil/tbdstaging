...
<div class="wfte_rtl_main wfte_invoice-main wfte_main wfte_custom_shipping_size"> 
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        <div class="wfte_col-1 float_left">
            <div class="wfte_company_logo wfte_hidden">
    ...
    <div class="wfte_row wfte_padding_left_right clearfix" style="margin-top:10px;">
        <div class="wfte_col-4 float_left" style="height: 1px;"></div>
        <div class="wfte_col-2 float_left" style="text-align: center;">
        ...
        <div class="wfte_col-4 float_right" style="height: 1px;"></div>
    </div>
    <div class="clearfix"></div>
