...
.wfte_proforma_invoice_number {font-size: 14px;color: #000;font-weight: normal;height: auto;background: #f4f4f4;padding: 7px 10px;}
...
.wfte_special_notes,.wfte_transport_terms,.wfte_sale_terms{margin: 5px 0px;}
</style>
<div class="wfte_rtl_main wfte_invoice-main"> 
    <div class="wfte_row wfte_padding_left_right clearfix">       
        <div class="wfte_col-7 float_left">
            <div class="wfte_doc_title wfte_template_element" data-hover-id="doc_title">__[Proforma invoice]__</div>
        </div>
    </div>
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">       
        ...
        <div class="wfte_col-6 float_right">
            <div class="wfte_invoice_data">
                <div class="wfte_proforma_invoice_number wfte_template_element">
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        ...
        <div class="wfte_col-6 float_right wfte_text_left">          
            <div class="wfte_invoice_data_grey">
                <div class="wfte_invoice_data">
                    <div class="wfte_proforma_invoice_date wfte_template_element" data-proforma_invoice_date-format="m-d-Y">
                      <span class="wfte_proforma_invoice_date_label">__[Proforma Invoice date:]__</span> [wfte_proforma_invoice_date]
                    </div>
                    <div class="wfte_order_number wfte_template_element">
                    ...
                    <div class="wfte_ssn_number wfte_template_element">
            ...
            <table class="wfte_payment_summary_table wfte_product_table wfte_side_padding_table">
                <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_product_table_payment_method">
                        ...
                        <td class="wfte_right_column wfte_text_left">[wfte_product_table_payment_method]</td>
                    </tr>
