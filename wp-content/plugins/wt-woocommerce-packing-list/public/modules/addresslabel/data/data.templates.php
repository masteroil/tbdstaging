...
$template_arr=array(
	array(
		'id'=>'template1',
		'title'=>__('WL-875(10x3) - Avery 5160-Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template2',
		'title'=>__('WL-125(5X2) - Avery 5163-Shipping Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template3',
		'title'=>__('WL-150(3X2) - Avery 5164-Shipping Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template4',
		'title'=>__('WL-100(7X2) - Avery 5162-Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template5',
		'title'=>__('WL-75(10X2) - Avery 5161-Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template6',
		'title'=>__('WL-25(20X4) - Avery 5167-Return Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template7',
		'title'=>__('WL-5195(15X4) - Avery 5195-Return Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template8',
		'title'=>__('WL-8275(10X3) - Avery 8275-Address Label', 'wf-woocommerce-packing-list'),
	),
	array(
		'id'=>'template9',
