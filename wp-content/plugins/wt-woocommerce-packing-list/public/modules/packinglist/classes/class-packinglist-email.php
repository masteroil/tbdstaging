...
class Wf_Woocommerce_Packing_List_Packinglist_Email extends WC_Email {
	...
	public function __construct() 
	{
		...
		$this->description = sprintf( __( 'Send Packing Slip as PDF attachment to warehouse when an order is placed. Use these available placeholders: %s', 'woocommerce' ), '<code>{site_title}, {order_date}, {order_number}</code>' );
	...
	{
		$default_subject = 	__('Packing Slip for order #{order_number} on {site_title}', 'wf-woocommerce-packing-list');
	...
	{	
		$default_heading = __('Packing Slip for order #{order_number}', 'wf-woocommerce-packing-list');
