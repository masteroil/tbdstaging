...
<div class="wfte_rtl_main wfte_invoice-main">
    <div class="wfte_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">
        ...
        <div class="wfte_col-6 float_right">
            <div class="wfte_invoice_data" style="text-align:right;">
                <div class="wfte_invoice_number"> <span class="wfte_invoice_number_label">__[INVOICE]__#</span> <span class="wfte_invoice_number_val" style="font-weight: bold;">[wfte_invoice_number] </span></div>
            </div>
        </div> 
    </div> 
    <div class="wfte_row wfte_padding_left_right clearfix" style="margin-bottom:20px;">                             
        ...
        <div class="wfte_col-3 float_right">
            <div class="wfte_invoice_data" style="text-align:right;">
                ...
                <div class="wfte_shipping_method">
                    ...
                    <span class="wfte_shipping_method_val" style="font-weight: bold;">[wfte_shipping_method]</span>
                </div>
                <div class="wfte_tracking_number">
                    <span class="wfte_tracking_number_label">__[Tracking number:]__ </span>
                    <span class="wfte_tracking_number_val" style="font-weight: bold;">[wfte_tracking_number]</span>
                </div>
                <div class="wfte_vat_number">
                    <span class="wfte_vat_number_label">__[VAT:]__ </span>
                    <span style="font-weight: bold;">[wfte_vat_number]</span>
                </div>
                <div class="wfte_ssn_number">
                    <span class="wfte_ssn_number_label">__[SSN:]__ </span>
                    <span style="font-weight: bold;">[wfte_ssn_number]</span>
                </div>
            </div> 
        </div>
    </div>
...
<div class="wfte_padding_left_right template_footer clearfix">
    <div class="wfte_col-1">
        <div class="wfte_footer clearfix">
            [wfte_footer]
        </div>
    </div>
</div>