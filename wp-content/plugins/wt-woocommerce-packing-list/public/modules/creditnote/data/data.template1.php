...
<div class="wfte_rtl_main wfte_invoice-main"> 
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        ...
        <div class="wfte_col-6 float_right wfte_text_left">          
            <div class="wfte_invoice_data">
                <div class="wfte_creditnote_number wfte_template_element">
                    <span class="wfte_creditnote_number_label">__[Credit note No:]__</span> [wfte_creditnote_number]
                </div>
                <div class="wfte_creditnote_date wfte_template_element" data-creditnote_date-format="m-d-Y">
                    <span class="wfte_creditnote_date_label">__[Credit note Date:]__</span> [wfte_creditnote_date]
                </div>
                <div class="wfte_invoice_number wfte_template_element">
