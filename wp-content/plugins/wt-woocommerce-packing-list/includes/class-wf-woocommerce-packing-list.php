...
class Wf_Woocommerce_Packing_List {
    ...
    */
	...
	private function load_dependencies() {
		...
		/**
		 * Includes admin notification class file
		 */ 
    ...
    */
	...
	/**
	 * @since 4.4.0 Get values for checkbox fields when they are unchecked
 	 */ 
	...
	/**
	 * @since 4.4.0
	 * Function to load default values for checkboxes when they are unchecked.
