...
function wt_pklist_get_customize_panel_html($type,$template_type)
{
	...
	}elseif($type=='barcode' || $type == 'package_no')
	{
	...
	}elseif($type=='email' || $type=='tel' || $type=='vat_number' || $type=='ssn_number' || $type=='shipping_method' || $type=='tracking_number' || $type == 'total_no_of_items')
	{
		$fields=array(
			array(
				'label'=>__('Title','wf-woocommerce-packing-list'),
	...
	}elseif($type=='product_table')
	{
		$fields=array(
			...
			array(
				'label'=>__('Serial No label','wf-woocommerce-packing-list'),
				'css_prop'=>'html',
				'trgt_elm'=>'product_table_head_serial_no',
				'width'=>'44%',
			),
			array(
				'label'=>__('Serial no text align','wf-woocommerce-packing-list'),
				'type'=>'select',
				'select_options'=>Wf_Woocommerce_Packing_List_Customizer::get_customizer_presets('text-align'),
				'css_prop'=>'text-align',
				'trgt_elm'=>'product_table_head_serial_no',
