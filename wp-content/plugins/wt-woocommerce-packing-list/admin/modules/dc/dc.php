...
class Wf_Woocommerce_Packing_List_Dc
{
	...
	{	
		$switch_to_classic_customizer=apply_filters('wt_pklist_switch_to_classic_customizer', false, $base);
		if($switch_to_classic_customizer && Wf_Woocommerce_Packing_List_Admin::module_exists('customizer'))
		{
			$customizer=Wf_Woocommerce_Packing_List_Customizer::get_instance();
			$customizer->init($base);
			return;
		}
		...
		*/
		...
		$params=array(
	        ...
	        'labels'=>array(
	        	...
	        	'cancel_prompt'=>__("All unsaved changes will be lost. Are you sure?",'wf-woocommerce-packing-list'),        	
	        	...
	        	'delete_row'=>__("Delete the row",'wf-woocommerce-packing-list'),
	        	'delete_block'=>__("Delete the block",'wf-woocommerce-packing-list'),
	        	...
	        	'insert_after'=>__("Insert a row below",'wf-woocommerce-packing-list'),
	        	'insert_before'=>__("Insert a row above",'wf-woocommerce-packing-list'),
	        	'move_up'=>__("Move up",'wf-woocommerce-packing-list'),
	        	'move_down'=>__("Move down",'wf-woocommerce-packing-list'),
	        	'edit_row'=>__("Edit row properties", 'wf-woocommerce-packing-list'),
	        	...
	        	'enter_mandatory_non_numeric_fields'=>__('Meta key should not be numeric','wf-woocommerce-packing-list'),
	        	'edit_html'=>__("HTML Editor (Block)", 'wf-woocommerce-packing-list'),
	        	'title'=>__("Header text", 'wf-woocommerce-packing-list'),
	        	'empty_item'=>__("Empty item", 'wf-woocommerce-packing-list'),
	        	'bulk_action_no_items_found'=>__("No items found", 'wf-woocommerce-packing-list'),
	        	'choose_a_block_from_editor'=>__("Choose a block from the preview pane to edit.", 'wf-woocommerce-packing-list'),
	        	...
	        	'footer_delete_prompt' => __("Are you sure to delete the footer div?",'wf-woocommerce-packing-list'),
	        	'prompt_leave_customizer' => __("Are you sure you want to leave the customizer?",'wf-woocommerce-packing-list'),
	        ),
		...
		$editor=array(
			'content'=>array(
				...
				'fields'=>array(
					...
					'text'=>array(
						'label'=>__('Input text', 'wf-woocommerce-packing-list'),
						'width'=>'100%',
					),
					'attr-src'=>array(
			...
			'typography'=>array(
				'title'=>__('Typography', 'wf-woocommerce-packing-list'),
				'id'=>'typography',
				'fields'=>array(
					'font-family'=>array(
					...
					'text-align'=>array(
						...
						'icons'=>array('<span class="dashicons dashicons-editor-alignleft" title="'.__('Left', 'wf-woocommerce-packing-list').'"></span>', '<span class="dashicons dashicons-editor-aligncenter" title="'.__('Center', 'wf-woocommerce-packing-list').'"></span>', '<span class="dashicons dashicons-editor-alignright" title="'.__('Right', 'wf-woocommerce-packing-list').'"></span>'),
					),
					'text-style'=>array(
						...
						'items'=>array(
							'font-weight'=>array(
								...
								'icon'=>'<span class="dashicons dashicons-editor-bold" title="'.__('Bold', 'wf-woocommerce-packing-list').'"></span>',
							),
							'font-style'=>array(
								'label'=>'&nbsp;',
								'field_type'=>'button_checkbox',
								'values'=>array('italic', 'normal'),
								'icon'=>'<span class="dashicons dashicons-editor-italic" title="'.__('Italic', 'wf-woocommerce-packing-list').'"></span>',
							),
						)
					),
			...
			'date-format'=>array(
				'title'=>__('Date Format', 'wf-woocommerce-packing-list'),
				'id'=>'date-format',
				'fields'=>array(
	...
	private function prepare_extra_fields_for_assets(&$extra_fields, &$extra_field_editable_properties, &$extra_field_html, &$extra_field_placeholders, &$extra_field_deletable)
	{
	    ...
	    foreach($extra_fields as $extra_field_key => $value)
	    {
	    	...
	    	$extra_field_html.='
		    	<div class="'.$css_class.'"> 
		        	<span class="'.$css_class.'_label">__['.esc_html($value).':]__ </span> 
		        	<span class="'.$css_class.'_val">'.esc_html($placeholder).'</span>
		        </div>';
	...
	private function prepare_order_fields_for_assets(&$order_fields, &$order_field_editable_properties, &$order_field_html)
	{
		$order_fields=array(
			...
			'payment_link' => __('Pay Now','wf-woocommerce-packing-list'),
		);
		...
		$order_field_editable_properties=array(
			...
			'payment_link'=>$editable_properties_1,
	    );
	    ...
	    $order_field_html='
	        ...
	        <div class="wfte_invoice_date" data-invoice_date-format="m-d-Y">
	...
	public function get_assets($template_type)
	{
		...
		*/
	    ...
	    $other_assets = array(
				...
				'sub_items'	=>array(
					...
					array(
						...
						'placeholders'	=>array(),
						'editable_properties'=>array(
					    	'return_policy'=>array('margin', 'padding', 'background-color', 'font-size', 'line-height', 'color', 'text-style', 'text-align', 'border'),
					    ),
					    'elements'=>array(
					...
					array(
						...
						'placeholders'	=>array(),
						'editable_properties'=>array(
					    	'footer'=>array('margin', 'padding', 'background-color', 'font-family','font-size', 'line-height', 'color', 'text-style', 'text-align', 'border'),
					    ),
					    'elements'=>array(
					...
					array(
						...
						'placeholders'	=>array(),
						'editable_properties'=>array(
					    	'barcode'=>array('margin', 'background-color', 'float'),
					    ),
					    'elements'=>array(
					...
					array(
						...
						'placeholders'	=>	array(),
						'editable_properties'=>array(
					    	'received_seal'=>array('text', 'width', 'height', 'margin', 'typography', 'border', 'received-seal'),
					    ),
					    'elements'=>array(
		...
		$other_assets = apply_filters('wt_pklist_dc_alter_individual_assets',$other_assets,$template_type,'others');
		$assets=array(
			array(
				'type'=>'group',
				'slug'=>'company_logo',
				...
				'sub_items'=>array(
					array(
					    ...
					    'editable_properties'=>array(
					    	...
					    	'company_name'=>array('margin', 'padding', 'background-color', 'typography', 'hideable'),
					    	'company_logo_extra_details'=>array('margin', 'padding', 'background-color', 'html', 'typography', 'hideable'),
					    ),
					    'elements'=>array(
				...
				'sub_items'=>array(
					array(
					    ...
					    'elements'=>array(
					    	...
					    	'from_address_vat'=>__('Company Tax ID', 'wf-woocommerce-packing-list'),
					    )
					),
					array(
						'type'	=> 'element',
					...
					array(
						...
						'editable_properties'=>array(
					    	...
					    	'shipping_address_phone' => $address_item_editable_properties,
					    ),
					    'elements'=>array(
					    	...
					    	'shipping_address_phone'=>__('Phone', 'wf-woocommerce-packing-list'),
					    )
					),
					array(
						'type'	=>'element',
						...
						'html'	=> '<div class="wfte_return_address">
						                ...
						                <div class="wfte_return_address_val">
						                    ...
						                    <span class="wfte_return_address_address_line1_address_line2"><span class="wfte_return_address_address_line1">[wfte_return_address_address_line1]</span>, <span class="wfte_return_address_address_line2">[wfte_return_address_address_line2]</span> <br /></span>
						                    <span class="wfte_return_address_city_state_postcode_country"><span class="wfte_return_address_city">[wfte_return_address_city],</span> <span class="wfte_return_address_state">[wfte_return_address_state],</span> <span class="wfte_return_address_postcode">[wfte_return_address_postcode],</span><br /></span>
						                    <span class="wfte_return_address_country">[wfte_return_address_country]</span>
						                </div>
						            </div>',
						'placeholders'=>array(),
						'editable_properties'=>array(
					    	...
					    	'return_address_address_line1'=>$address_item_editable_properties,
					    	'return_address_address_line2'=>$address_item_editable_properties,
					    ...
					    'elements'=>array(
					    	...
					    	'return_address_address_line1'=>__('Address line 1', 'wf-woocommerce-packing-list'),
					    	'return_address_address_line2'=>__('Address line 2', 'wf-woocommerce-packing-list'),
			...
			array(
			    ...
			    'add_new_element'=>array(
			    	...
			    	<div class="wt_pklist_dc_add_new_sub_item_block">
			    		<label class="wt_pklist_dc_add_new_sub_item_label">'.__('Enter label', 'wf-woocommerce-packing-list').'</label>
			    	...
			    	<div class="wt_pklist_dc_add_new_sub_item_block">
			    		...
			    		<input type="text" class="wt_pklist_dc_property_editor_add_new_item_value" id="dc_add_new_order_meta" oninput="do_auto_complete_for_order_meta()" />
			    	</div>
			    	',
			    ),
			),					
				...
				'sub_items'=>array(
					array(
						...
						'add_new_element'=>array(
					    	...
					    	'editable_property'=>array('text', 'width', 'height', 'background-color', 'typography', 'removable', 'sortable'),
					    	'sample_html'=>'<th class="wfte_product_table_head_bg wfte_table_head_color" col-type=""></th>',
					    	'html'=>'
					    	<div class="wt_pklist_dc_add_new_sub_item_block">
					    		<label class="wt_pklist_dc_add_new_sub_item_label">'.__('Column header', 'wf-woocommerce-packing-list').'</label>
					    		<input type="text" class="wt_pklist_dc_property_editor_add_new_item_title" />
					    	</div>
					    	<div class="wt_pklist_dc_add_new_sub_item_block">
					    		<label class="wt_pklist_dc_add_new_sub_item_label">'.__('Select a value', 'wf-woocommerce-packing-list').'</label>
					    	...
					    	<div class="wt_pklist_dc_add_new_sub_item_block wt_pklist_dc_form_toggler_child_block" data-form-toggle-target="product_table_add_new" data-form-toggle-value="custom_product_meta">
					    		<label class="wt_pklist_dc_add_new_sub_item_label">'.__('Enter product meta key', 'wf-woocommerce-packing-list').'</label>
					    	...
					    	<div class="wt_pklist_dc_add_new_sub_item_block wt_pklist_dc_form_toggler_child_block" data-form-toggle-target="product_table_add_new" data-form-toggle-value="custom_order_item_meta">
					    		<label class="wt_pklist_dc_add_new_sub_item_label">'.__('Enter order item meta key', 'wf-woocommerce-packing-list').'</label>
					    		<input type="text" class="wt_pklist_dc_property_editor_add_new_item_value_data" />
					    	</div>
					    ...
					    'editable_properties'=>array(
					    	...
					    	'product_table_body'=>array('padding', 'background-color', 'font-size', 'text-style', 'color', 'line-height'),
					    	'product_table_head_serial_no'=>$table_head_editable_properties,
					    ...
					    'elements'=>array(
					    	...
					    	'product_table_head_serial_no'=>__('No', 'wf-woocommerce-packing-list'),
					...
					array(
					    ...
					    'add_new_element'=>array(
					    	...
					    	'editable_property'=>array('label-text', 'height', 'background-color', 'typography', 'removable', 'sortable'),
					    	'sample_html'=>'
	...
	{
		return array('width', 'padding', 'background-color', 'font-family', 'font-size', 'line-height', 'color', 'border');
	}
	...
	*/
	...
	{
		$dom_elements=array(
			'col-+\d+', /* columns format. Eg: col-1, col-6 */
		);
	...
	*/
	public function get_layouts($template_type)
	{
		...
		); /* If adding new elements. Please confirm the templates compatibility. Including blank templates */
	...
	/**
	*	The dom elements to be excluded while adding `data-wfte-id` attribute.	
	*/
	...
	private function enqueue_scripts()
	{
		...
		*/
		...
		wp_enqueue_script($this->module_id, plugin_dir_url( __FILE__ ).'assets/js/pklist_dc.js', array('jquery','jquery-ui-autocomplete', 'wp-color-picker'), WF_PKLIST_VERSION);
	...
	*/
	public function color_picker($css_property, $css_class='')
	{
		...
		<div class="wt_pklist_dc_color_picker">
	    	...
	    	<input type="text" class="wt_pklist_dc_property_editor_input wt_pklist_dc_color_picker_input <?php echo esc_attr($css_class);?>" value="#fff" data-css-property="<?php echo esc_attr($css_property);?>"/>
	    </div>
		<?php
	}
	...
	public function prepare_four_side_input($field_sub_type, $field_key, $css_class, $dropdown_items=array())
	{
		...
		}elseif($field_sub_type=='dropdown')
		{
			...
			?>
			<select class="wt_pklist_dc_property_editor_input wt_pklist_dc_change <?php echo esc_attr($css_class);?>">
			<?php
		...
		{
		?>
			<input type="text" class="wt_pklist_dc_property_editor_input wt_pklist_dc_keyup <?php echo esc_attr($css_class);?>" value="" style="width:95%;">
		<?php
		}
	}
	...
	public function button_radio($field_key, $item_field_value)
	{
		...
		{
			?>
			<div class="wt_pklist_dc_sidebar_property_button_radio_group" data-property="<?php echo esc_attr($field_key);?>">
				<?php
				foreach($item_field_values as $btn_item_inc=>$btn_item_value)
				{
					...
					?>
					<span class="wt_pklist_dc_sidebar_property_button_group_btn wt_pklist_button_radio" data-value="<?php echo esc_attr($btn_item_value);?>" style="height:28px; line-height:28px;"><?php echo wp_kses_post($icon);?></span>
					<?php
				}
				?>
			</div>
