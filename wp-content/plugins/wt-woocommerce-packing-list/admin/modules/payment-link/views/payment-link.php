...
$payment_link_doc_url = "https://www.webtoffee.com/how-to-accept-woocommerce-invoice-payment/";
?>
<div class="wf-tab-content" data-id="<?php echo $target_id;?>">
<p> 
	<?php 
		echo sprintf(__("Adds a payment link in your invoice to let customers pay later. Upon clicking on the payment link, your customers will be redirected to your store's payment/checkout page. %s Learn more. %s ",'wf-woocommerce-packing-list'),'<a href="'.esc_url($payment_link_doc_url).'" target="_blank">', '</a>')
	?>
</p>
...
<table class="wf-form-table">
	...
	Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
		array(
			...
			'help_text'=> __("Adds a payment link beside the payment method in the invoice. Ensure to choose a template from the ‘Customize’ tab that supports the payment link.","wf-woocommerce-packing-list"),
		),
		array(
			...
			'help_text'=> __("Adds payment link for selected order statuses. Even if nothing is selected, 'On hold' status will be considered.","wf-woocommerce-packing-list"),
		),
		array(
			'type' => 'checkbox',
