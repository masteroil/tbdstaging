...
<div class="wrap">
    ...
    <?php _e('Addons','wf-woocommerce-packing-list');?>: <?php _e('WooCommerce PDF Invoices, Packing Slips, Delivery Notes and Shipping Labels
        ...
        <div class="wt_addon_div">
            <div style="display:flex;">
                <div class="qrcode_promotion_content">
                    <h3 style="font-size:1.7em;"><?php _e("QR Code Addon for WooCommerce PDF Invoices","wf-woocommerce-packing-list"); ?></h3>
                    ...
                    <a href="https://www.webtoffee.com/product/qr-code-addon-for-woocommerce-pdf-invoices/?utm_source=pro_plugin_addon_page&utm_medium=PDF_invoice_pro&utm_campaign=QR_Code_Addon&utm_content=<?php echo WF_PKLIST_VERSION; ?>" class="buy_qrcode_btn" target="_blank"><?php echo __('Get Plugin','wf-woocommerce-packing-list'); ?></a>
                </div>
        ...
        <div class="wt_addon_div">
            <div style="display:flex;">
                <div class="qrcode_promotion_content" style="width:75%;">
                    <h3 style="font-size:1.7em;line-height: 1.2em;"><?php _e("Remote Print Addon for WooCommerce PDF Invoices – PrintNode","wf-woocommerce-packing-list"); ?></h3>
                    <p style="font-size: 14px;"><?php _e('Enables remote cloud printing for WooCommerce PDF Invoices with PrintNode.','wf-woocommerce-packing-list'); ?></p>
                    <ul class="printnode_pre_placeholders" style="width:45%;">
                        <li><?php _e('Supports PDF Printing','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Faster printing of WooCommerce PDF Invoices ','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Integration with PrintNode','wf-woocommerce-packing-list'); ?></li>
                    </ul>
                    <ul class="printnode_pre_placeholders" style="width:40%;">
                        <li><?php _e('Secure print with base64 and URI printing','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Automatic & Manual printing','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Compatible with Windows, macOS / OS X, Linux, and Raspberry Pi.','wf-woocommerce-packing-list'); ?></li>
                    </ul>
                    <a href="https://www.webtoffee.com/product/remote-print-woocommerce-pdf-invoice-printnode/?utm_source=pro_plugin_addon_page&utm_medium=PDF_invoice_pro&utm_campaign=Remote_Print_Addon&utm_content=<?php echo WF_PKLIST_VERSION; ?>" class="buy_qrcode_btn" target="_blank"><?php echo __('Get Plugin','wf-woocommerce-packing-list'); ?></a>
                </div>
        ...
        <div class="wt_addon_div">
            <div style="display:flex;">
                <div class="qrcode_promotion_content" style="width:75%;padding-right: 1.5em;">
                    <h3 style="font-size:1.7em;line-height: 1.2em;"><?php _e("mPDF add-on for PDF Invoices, Packing Slips, Delivery Notes & Shipping Labels","wf-woocommerce-packing-list"); ?></h3>
                    <p style="font-size: 14px;"><?php _e('This addon works with PDF Invoices, Packing Slips, Delivery Notes & Shipping Labels plugin to support RTL layout and Unicode for different languages.','wf-woocommerce-packing-list'); ?></p>
                    <ul class="printnode_pre_placeholders" style="width:45%;">
                        <li><?php _e('Handles 12 RTL languages','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Support for all languages including Unicode standard','wf-woocommerce-packing-list'); ?></li>
                    </ul>
                    <ul class="printnode_pre_placeholders" style="width:40%;">
                        <li><?php _e('Prints Hebrew and Arabic languages','wf-woocommerce-packing-list'); ?></li>
                        <li><?php _e('Enables easy print, download, and attachment provisions','wf-woocommerce-packing-list'); ?></li>
                    </ul>
                    <a href="https://wordpress.org/plugins/mpdf-addon-for-pdf-invoices" class="buy_qrcode_btn" target="_blank"><?php echo __('Get Plugin','wf-woocommerce-packing-list'); ?></a>
                </div>
                <div class="qrcode_promotion_img" style="width:35%;margin-left: auto;">
