...
if(is_array($args))
{
	...
	{	
		...
		*/
		...
		{	
			$allowed_label_for_fields = array('text','textarea','pdf_name_prefix');
			...
			if($field_only===false)
			{
				...
				<tr valign="top" <?php echo $tr_id.$field_group_attr;?> <?php echo $form_toggler_child; ?> class="<?php echo $tr_class;?>">
			        <th scope="row" >
			        	<label for="<?php if(in_array($type,$allowed_label_for_fields)){echo $field_name;}?>">
				...
				<tr valign="top" <?php echo $tr_id.$field_group_attr;?> <?php echo $form_toggler_child; ?> class="<?php echo $tr_class;?>">
			        <th scope="row" >
			        	<label for="<?php if(in_array($type,$allowed_label_for_fields)){echo $field_name;}?>" style="margin-left: 15px;">
			        		<?php echo isset($value['label']) ? $value['label'] : ''; ?><?php echo ($mandatory ? '<span class="wt_pklist_required_field">*</span>' : ''); ?><?php echo $tooltip_html;?>	
			        	</label>
			        </th>
			        <td>
			...
			}else
			{
				...
				{
	        	?>
	            	<input type="text" <?php echo $fld_attr;?> name="<?php echo $field_name;?>" value="<?php echo $vl;?>" class="<?php echo $field_class; ?>" />
	            <?php
	        	}
	        	if($type=='number')
				{
				?>
	            	<input type="number" <?php echo $fld_attr;?> name="<?php echo $field_name;?>" value="<?php echo $vl;?>" class="<?php echo $field_class; ?>" />
	            <?php
				}
				...
				?>
					...
					$checkbox_conditions = isset($value['checkbox_fields_condition']) ? $value['checkbox_fields_condition'] : array();
					if(!empty($checkbox_fields)){
						foreach($checkbox_fields as $key => $checkbox_label){
							$checked = '';
							if(!empty($checkbox_conditions) && array_key_exists($vl, $checkbox_conditions)){
								if(in_array($key,$checkbox_conditions[$vl])){
									$checked = 'checked="checked"';
								}
							}

					?>
					<input id="<?php echo $field_name.'_'.$key; ?>" type="checkbox" class="<?php echo $form_toggler_p_class;?>" value="<?php echo $key; ?>" name="<?php echo $field_name.'[]';?>" <?php echo $checked; ?>> <?php echo $checkbox_label; ?>
					<?php
						}
					}
				...
				elseif($type=='radio') //radio button
				{
					...
					?>
					<span style="display:inline-block;"><input type="radio" id="<?php echo $field_id.'_'.$rad_vl;?>" name="<?php echo $field_name;?>" class="<?php echo $form_toggler_p_class;?> <?php echo esc_attr($field_class); ?>" <?php echo $form_toggler_register;?> value="<?php echo $rad_vl;?>" <?php echo $checked_attr; ?> <?php echo $fld_attr;?> /> <?php echo $rad_label; ?> </span>
					&nbsp;&nbsp;
					<?php
