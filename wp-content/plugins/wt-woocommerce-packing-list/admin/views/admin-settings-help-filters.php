...
<input type="text" placeholder="search filter" id="filter_search_input_updated" style="float: left;margin: 0 0 15px 0;width: 48%;border: 1px solid #ccc;">
				...
				?>
					<tr class="bordered view">
						...
						<td class="filter_actions">
							<span class="dashicons dashicons-arrow-down-alt2" title="<?php echo __('Example Code','wf-woocommerce-packing-list');?>"></span>
							...
							<div class="filter_desc">
								<?php 
									...
									if(isset($value['params']) && trim($value["params"]) != ""){
										echo "<br>".__('Hook','wf-woocommerce-packing-list').": ".$key."<br>";
										echo __('Parameters','wf-woocommerce-packing-list').": ".$value['params']."<br>";
									}
								?>
							</div>
						</td>
							...
							?>
								<div class="wf_filter_code_div" style="position:relative;">
									<div class="filter_code_copy" style="float: left;text-align: right;position: relative;padding: 0;bottom: 0;position: absolute;right: 2px;opacity: 0.5;">
										<img src="<?php echo WF_PKLIST_PLUGIN_URL.'admin/images/copy-code.png'; ?>" title="<?php echo __('Copy Code','wf-woocommerce-packing-list');?>" style="width: 25px;display: inline-block;background: #2b3337;border-radius: 25px;height: 25px;padding: 5px;">
									</div>
								<?php 
