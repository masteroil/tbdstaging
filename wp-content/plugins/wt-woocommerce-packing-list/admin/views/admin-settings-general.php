	...
	<table class="wf-form-table">
		...
		self::generate_form_field(array(
			...
			array(
				...
				'help_text'=>__("Ensure to select company logo from ‘Invoice > Customize > Company Logo’ to reflect on the invoice. Recommended size is 150x50px.", 'wf-woocommerce-packing-list'),
			),
			array(
				'label'=>__("Company Tax ID",'wf-woocommerce-packing-list'), 
				'option_name'=>"woocommerce_wf_packinglist_sender_vat",
				'help_text'=>__("Specify your company tax ID. For e.g. you may enter as VAT: GB123456789, GSTIN:0948745 or ABN:51 824 753 556", 'wf-woocommerce-packing-list'),
			),
			array(
				'type'=>'textarea',
