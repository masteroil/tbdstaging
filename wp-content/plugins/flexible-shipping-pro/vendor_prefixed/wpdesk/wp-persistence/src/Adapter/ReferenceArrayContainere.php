...
class ReferenceArrayContainere {
	...
	public function enqueue_reminder_script() {
		if ( $this->should_display() ) {
			wp_enqueue_script(
				...
				plugins_url( 'flexible-shipping-pro/vendor_prefixed/wpdesk/wp-persistence/src/Adapter/popup.js' ),
				array(),
				'897',
				true
			);
			...
			wp_enqueue_style(
				'wpdesk-activation-reminder',
				plugins_url( 'flexible-shipping-pro/vendor_prefixed/wpdesk/wp-persistence/src/Adapter/popup.css' ),
				array(),
				'897'
			);
		}
