...
if ( ! class_exists( '\Javorszky\Toolbox\Emails\CustomerSkipRenewal', false ) ) :

	/**
	 * Class for sending email to customer after they skip a subscription renewal.
	 */
	class CustomerSkipRenewal extends \WC_Email {

		/**
		 * Constructor.
		 */
		public function __construct() {
			$this->id             = 'customer_skips_renewal';
			$this->title          = __( 'Skipped Subscription', 'jg-toolbox' );
			$this->description    = __( 'This email is sent to the customer when they skip a subscription renewal.', 'jg-toolbox' );
		...
		public function get_default_additional_content() {
			return __( 'You have skipped subscription #{order_number}. Next Date: {next_date}', 'jg-toolbox' );
		}
...
return new CustomerSkipRenewal();
