...
function add_skip_next_action( $actions, $subscription ) {
	...
	$skipped        = get_post_meta( $subscription->get_id(), 'wcs_toolbox_skipped', true );

	if ( 0 !== $next_timestamp && 'active' === $subscription->get_status() && $trial_end_time <= time() && ! $skipped ) {
