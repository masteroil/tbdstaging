...
function validate_subscription_ownership( $user_id, $subscription ) {
	if ( ! wcs_is_subscription( $subscription ) ) {
		...
		wc_add_notice( _x( 'This does not appear to be one of your subscriptions.', 'Error notice while validating subscription ownership during all actions.', 'jg-toolbox' ), 'error' );
		return false;
	}
