...
class ProjectApi
{
     ...
     */
    public function createTask($xero_tenant_id, $project_id, $task_create_or_update)
    {
        list($response) = $this->createTaskWithHttpInfo($xero_tenant_id, $project_id, $task_create_or_update);
        return $response;
    }
    /**
     ...
     */
    public function createTaskWithHttpInfo($xero_tenant_id, $project_id, $task_create_or_update)
    {
        $request = $this->createTaskRequest($xero_tenant_id, $project_id, $task_create_or_update);
        try {
            $options = $this->createHttpClientOption();
            try {
                $response = $this->client->send($request, $options);
     ...
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function createTaskAsync($xero_tenant_id, $project_id, $task_create_or_update)
    {
        return $this->createTaskAsyncWithHttpInfo($xero_tenant_id, $project_id, $task_create_or_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Promise\PromiseInterface */
    public function createTaskAsyncWithHttpInfo($xero_tenant_id, $project_id, $task_create_or_update)
    {
        $returnType = '\Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Models\Project\Task';
        $request = $this->createTaskRequest($xero_tenant_id, $project_id, $task_create_or_update);
        return $this->client
     ...
     * @throws \InvalidArgumentException
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Psr7\Request  */
    protected function createTaskRequest($xero_tenant_id, $project_id, $task_create_or_update)
    {
        // verify the required parameter 'xero_tenant_id' is set
        if ($xero_tenant_id === null || (is_array($xero_tenant_id) && count($xero_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function updateTask($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
    {
        $this->updateTaskWithHttpInfo($xero_tenant_id, $project_id, $task_id, $task_create_or_update);
    }
    /**
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTaskWithHttpInfo($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
    {
        $request = $this->updateTaskRequest($xero_tenant_id, $project_id, $task_id, $task_create_or_update);
        try {
            $options = $this->createHttpClientOption();
            try {
                $response = $this->client->send($request, $options);
     ...
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaskAsync($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
    {
        return $this->updateTaskAsyncWithHttpInfo($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Promise\PromiseInterface */
    public function updateTaskAsyncWithHttpInfo($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
    {
        $returnType = '';
        $request = $this->updateTaskRequest($xero_tenant_id, $project_id, $task_id, $task_create_or_update);
        return $this->client
     ...
     * @throws \InvalidArgumentException
     * @return \Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Psr7\Request  */
    protected function updateTaskRequest($xero_tenant_id, $project_id, $task_id, $task_create_or_update)
    {
        // verify the required parameter 'xero_tenant_id' is set
        if ($xero_tenant_id === null || (is_array($xero_tenant_id) && count($xero_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
